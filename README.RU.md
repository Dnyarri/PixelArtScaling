...
[**VisualNxGUI.py**](https://github.com/Dnyarri/PixelArtScaling/blob/main/VisualNxGUI.py) - недавно добавленная программа для масштабирования одной картинки с превью. Позволяет легко сравнивать разные алгоритмы, а после сохранения результат масштабировать ещё дальше. Однако следует учитывать, что при подобном повторном масштабировании размер картинки растёт в геометрической прогрессии с каждым новым шагом, и процесс очень быстро становится несколько медленным.
